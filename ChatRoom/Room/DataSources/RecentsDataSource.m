...
- (NSAttributedString *)attributedStringForHeaderTitleInSection:(NSInteger)section
{
    ...
    {
        count = favoriteCellDataArray.count;
        title = NSLocalizedStringFromTableInBundle(@"room_recents_favourites_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    }
    else if (section == peopleSection)
    {
        count = peopleCellDataArray.count;
        title = NSLocalizedStringFromTableInBundle(@"room_recents_people_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    }
    else if (section == conversationSection)
    {
        ...
        {
            title = NSLocalizedStringFromTableInBundle(@"people_conversation_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
        else
        {
            title = NSLocalizedStringFromTableInBundle(@"room_recents_conversations_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
    }
    else if (section == directorySection)
    {
        title = NSLocalizedStringFromTableInBundle(@"room_recents_directory_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    }
    else if (section == lowPrioritySection)
    {
        count = lowPriorityCellDataArray.count;
        title = NSLocalizedStringFromTableInBundle(@"room_recents_low_priority_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    }
    else if (section == serverNoticeSection)
    {
        count = serverNoticeCellDataArray.count;
        title = NSLocalizedStringFromTableInBundle(@"room_recents_server_notice_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    }
    else if (section == invitesSection)
    {
        ...
        if (_recentsDataSourceMode == RecentsDataSourceModePeople)
        {
            title = NSLocalizedStringFromTableInBundle(@"people_invites_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
        else
        {
            title = NSLocalizedStringFromTableInBundle(@"room_recents_invites_section", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
    }
...
- (UIView *)badgeViewForHeaderTitleInHomeSection:(NSInteger)section
{
    ...
    if (count)
    {
        ...
        if (count > 1000)
        {
            ...
            missedNotifAndUnreadBadgeLabel.text = [NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"large_badge_value_k_format", @"Vector",[NSBundle bundleForClass:[self class]], nil), value];
        }
        else
        {
...
- (UIView *)viewForHeaderInSection:(NSInteger)section withFrame:(CGRect)frame
{
    ...
    if (sectionBitwise)
    {
        ...
        {
            chevron = [UIImage imageNamed:@"disclosure_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
        }
        else
        {
            chevron = [UIImage imageNamed:@"shrink_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
        }
    ...
    if (section == directorySection && _recentsDataSourceMode == RecentsDataSourceModeRooms && !(shrinkedSectionsBitMask & RECENTSDATASOURCE_SECTION_DIRECTORY))
    {
        ...
        if (!directorySectionContainer)
        {
            ...
            networkLabel.text = NSLocalizedStringFromTableInBundle(@"room_recents_directory_section_network", @"Vector",[NSBundle bundleForClass:[self class]], nil);
            ...
            chevronImageView.image = [UIImage imageNamed:@"disclosure_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
             ...
             || (indexPath.section == peopleSection && !peopleCellDataArray.count))
    {
        ...
        {
            tableViewCell.textLabel.text = NSLocalizedStringFromTableInBundle(@"search_no_result", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
        else if (_recentsDataSourceMode == RecentsDataSourceModePeople || indexPath.section == peopleSection)
        {
            tableViewCell.textLabel.text = NSLocalizedStringFromTableInBundle(@"people_no_conversation", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
        else
        {
            tableViewCell.textLabel.text = NSLocalizedStringFromTableInBundle(@"room_recents_no_conversation", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
...
- (void)refreshRoomsSections
{
    ...
    if (displayedRecentsDataSourceArray.count > 0)
    {
        ...
        if (_recentsDataSourceMode == RecentsDataSourceModeHome)
        {
            BOOL pinMissedNotif = LucSettings.shared.pinRoomsWithMissedNotificationsOnHome;
            BOOL pinUnread = LucSettings.shared.pinRoomsWithUnreadMessagesOnHome;            
