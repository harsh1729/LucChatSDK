...
{
    ReadReceiptsViewController *receiptsController = [[[self class] alloc] initWithNibName:NSStringFromClass([self class]) bundle:[NSBundle bundleForClass:[ReadReceiptsViewController class]]];
...
- (void)configureViews
{
    ...
    self.titleLabel.text = NSLocalizedStringFromTableInBundle(@"read_receipts_list", @"Vector",[NSBundle bundleForClass:[self class]], nil);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        NSString *receiptReadText = NSLocalizedStringFromTableInBundle(@"receipt_status_read", @"Vector",[NSBundle bundleForClass:[self class]], nil);
