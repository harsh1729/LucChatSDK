...
- (UIImage*)attachmentIcon
{
    ...
    {
        return [UIImage imageNamed:@"file_photo_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
    }
    else if ([msgtype isEqualToString:kMXMessageTypeAudio])
    {
        return [UIImage imageNamed:@"file_music_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
    }
    else if ([msgtype isEqualToString:kMXMessageTypeVideo])
    {
       return [UIImage imageNamed:@"file_video_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
    }
    ...
    {
        return [UIImage imageNamed:@"file_doc_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
    }
