...
- (UIImage*)attachmentIcon: (MXKAttachmentType)type
{
    ...
    switch (type)
    {
        case MXKAttachmentTypeImage:
            image = [UIImage imageNamed:@"file_photo_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
            break;
        case MXKAttachmentTypeAudio:
            image = [UIImage imageNamed:@"file_music_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
            break;
        case MXKAttachmentTypeVideo:
            image = [UIImage imageNamed:@"file_video_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
            break;
        case MXKAttachmentTypeFile:
            image = [UIImage imageNamed:@"file_doc_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
            break;
        default:
            break;
    }
