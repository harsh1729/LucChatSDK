...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        if (state == MXKDataSourceStateReady)
        {
            ...
            {
                tableViewCell.textLabel.text = NSLocalizedStringFromTableInBundle(@"room_directory_no_public_room", @"Vector",[NSBundle bundleForClass:[self class]], nil);
            }
        }
        else
        {
            if (_searchPattern.length)
            {
                tableViewCell.textLabel.text = NSLocalizedStringFromTableInBundle(@"search_in_progress", @"Vector",[NSBundle bundleForClass:[self class]], nil);
            }
            else
            {
