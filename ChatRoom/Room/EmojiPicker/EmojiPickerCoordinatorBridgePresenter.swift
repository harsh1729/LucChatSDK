...
@objc public protocol EmojiPickerCoordinatorBridgePresenterDelegate {
...
@objcMembers
final public class EmojiPickerCoordinatorBridgePresenter: NSObject {
    ...
    public weak var delegate: EmojiPickerCoordinatorBridgePresenterDelegate?
    
    // MARK: - Setup
    
    public init(session: MXSession, roomId: String, eventId: String) {
