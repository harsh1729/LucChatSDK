...
- (void)displayUnsentMessagesNotification:(NSString*)notification withResendLink:(void (^)(void))onResendLinkPressed andCancelLink:(void (^)(void))onCancelLinkPressed andIconTapGesture:(void (^)(void))onIconTapGesture
{
    ...
    {
        NSString *resendLink = NSLocalizedStringFromTableInBundle(@"room_prompt_resend", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        NSString *cancelLink = NSLocalizedStringFromTableInBundle(@"room_prompt_cancel", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    ...
    self.iconImageView.image = [UIImage imageNamed:@"error" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
...
- (void)displayTypingNotification:(NSString*)labelText
{
    ...
    if (labelText.length)
    {
        self.iconImageView.image = [UIImage imageNamed:@"typing" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
        self.messageLabel.text = labelText;
...
- (void)displayOngoingConferenceCall:(void (^)(BOOL))onOngoingConferenceCallPressed onClosePressed:(void (^)(void))onOngoingConferenceCallClosePressed
{
    ...
    {
        onGoingConferenceCall = [NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"room_ongoing_conference_call", @"Vector",[NSBundle bundleForClass:[self class]], nil),
                                 NSLocalizedStringFromTableInBundle(@"voice", @"Vector",[NSBundle bundleForClass:[self class]], nil),
                                 NSLocalizedStringFromTableInBundle(@"video", @"Vector",[NSBundle bundleForClass:[self class]], nil)];
    }
    else
    {
        ...
        onGoingConferenceCall = [NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"room_ongoing_conference_call_with_close", @"Vector",[NSBundle bundleForClass:[self class]], nil),
                                 NSLocalizedStringFromTableInBundle(@"voice", @"Vector",[NSBundle bundleForClass:[self class]], nil),
                                 NSLocalizedStringFromTableInBundle(@"video", @"Vector",[NSBundle bundleForClass:[self class]], nil),
                                 NSLocalizedStringFromTableInBundle(@"room_ongoing_conference_call_close", @"Vector",[NSBundle bundleForClass:[self class]], nil)];
    }
    ...
    NSRange voiceRange = [onGoingConferenceCall rangeOfString:NSLocalizedStringFromTableInBundle(@"voice", @"Vector",[NSBundle bundleForClass:[self class]], nil)];
    ...
    NSRange videoRange = [onGoingConferenceCall rangeOfString:NSLocalizedStringFromTableInBundle(@"video", @"Vector",[NSBundle bundleForClass:[self class]], nil)];
    ...
    if (onOngoingConferenceCallClosePressed)
    {
        NSRange closeRange = [onGoingConferenceCall rangeOfString:NSLocalizedStringFromTableInBundle(@"room_ongoing_conference_call_close", @"Vector",[NSBundle bundleForClass:[self class]], nil)];
...
- (void)displayScrollToBottomIcon:(NSUInteger)newMessagesCount onIconTapGesture:(void (^)(void))onIconTapGesture
{
    if (newMessagesCount)
    {
        ...
        self.iconImageView.image = [UIImage imageNamed:@"newmessages" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
        
        NSString *notification;
        if (newMessagesCount > 1)
        {
            notification = NSLocalizedStringFromTableInBundle(@"room_new_messages_notification", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
        else
        {
            notification = NSLocalizedStringFromTableInBundle(@"room_new_message_notification", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        }
    ...
    else
    {
        ...
        self.iconImageView.image = [UIImage imageNamed:@"scrolldown" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
    }
    self.iconImageView.hidden = NO;
...
- (void)displayRoomReplacementWithRoomLinkTappedHandler:(void (^)(void))onRoomReplacementLinkTapped
{
    ...
    if (onRoomReplacementLinkTapped)
    {
        ...
        NSString *roomReplacementReasonString = [NSString stringWithFormat:@"%@\n", NSLocalizedStringFromTableInBundle(@"room_replacement_information", @"Vector",[NSBundle bundleForClass:[self class]], nil)];
        ...
        NSString *roomLinkString = NSLocalizedStringFromTableInBundle(@"room_replacement_link", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    ...
    {
        self.messageTextView.text = NSLocalizedStringFromTableInBundle(@"room_replacement_information", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    }
...
- (void)showResourceLimit:(NSString *)limitType adminContactString:(NSString *)adminContactString hardLimit:(BOOL)hardLimit onAdminContactTapped:(void (^)(NSURL *adminContact))onAdminContactTapped
{
    ...
    else
    {
        if ([limitType isEqualToString:kMXErrorResourceLimitExceededLimitTypeMonthlyActiveUserValue])
        {
            [message appendString:NSLocalizedStringFromTableInBundle(@"room_resource_usage_limit_reached_message_1_monthly_active_user", @"Vector",[NSBundle bundleForClass:[self class]], nil)];
        }
        else
        {
            [message appendString:NSLocalizedStringFromTableInBundle(@"room_resource_usage_limit_reached_message_1_default", @"Vector",[NSBundle bundleForClass:[self class]], nil)];
        }

        message2 = [[NSAttributedString alloc] initWithString:NSLocalizedStringFromTableInBundle(@"room_resource_usage_limit_reached_message_2", @"Vector",[NSBundle bundleForClass:[self class]], nil)
                                                   attributes:@{
    ...
    NSAttributedString *messageContact1 = [[NSAttributedString alloc] initWithString:NSLocalizedStringFromTableInBundle(@"room_resource_limit_exceeded_message_contact_1", @"Vector",[NSBundle bundleForClass:[self class]], nil) attributes:attributes];
    NSAttributedString *messageContact2Link =  [[NSAttributedString alloc] initWithString:NSLocalizedStringFromTableInBundle(@"room_resource_limit_exceeded_message_contact_2_link", @"Vector",[NSBundle bundleForClass:[self class]], nil) attributes:messageContact2LinkAttributes];
    NSAttributedString *messageContact3;
    if (hardLimit)
    {
        messageContact3 = [[NSAttributedString alloc] initWithString:NSLocalizedStringFromTableInBundle(@"room_resource_limit_exceeded_message_contact_3", @"Vector",[NSBundle bundleForClass:[self class]], nil) attributes:attributes];
    }
    else
    {
        messageContact3 = [[NSAttributedString alloc] initWithString:NSLocalizedStringFromTableInBundle(@"room_resource_usage_limit_reached_message_contact_3", @"Vector",[NSBundle bundleForClass:[self class]], nil) attributes:attributes];
    }
