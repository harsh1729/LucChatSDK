...
@objcMembers
final public class RoomContextualMenuPresenter: NSObject {
    ...
    public func present(roomContextualMenuViewController: RoomContextualMenuViewController,
    ...
    public func hideContextualMenu(animated: Bool, completion: (() -> Void)?) {
