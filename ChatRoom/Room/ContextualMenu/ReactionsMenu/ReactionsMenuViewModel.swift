...
@objc final public class ReactionsMenuViewModel: NSObject, ReactionsMenuViewModelType {
    ...
    @objc public weak var coordinatorDelegate: ReactionsMenuViewModelCoordinatorDelegate?
    public weak var viewDelegate: ReactionsMenuViewModelViewDelegate?
    ...
    public func process(viewAction: ReactionsMenuViewAction) {
        switch viewAction {
        case .loadData:
            self.loadData()
