...
@objc public protocol RoomContextualMenuViewControllerDelegate: class {
    func roomContextualMenuViewControllerDidTapBackgroundOverlay(_ viewController: RoomContextualMenuViewController)
}

@objcMembers
final public class RoomContextualMenuViewController: UIViewController, Themable {
    ...
    public weak var delegate: RoomContextualMenuViewControllerDelegate?
    
    // MARK: - Setup
    
    public class func instantiate() -> RoomContextualMenuViewController {
    ...
    public func update(contextualMenuItems: [RoomContextualMenuItem], reactionsMenuViewModel: ReactionsMenuViewModel?) {
    ...
    public func selectedReactionAnimationsIntructionsPart1() {
        self.reactionsMenuView?.selectionAnimationInstructionPart1()
    }
    
    public func selectedReactionAnimationsIntructionsPart2() {
