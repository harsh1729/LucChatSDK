...
@objc public protocol CameraPresenterDelegate: class {
...
@objc public final class CameraPresenter: NSObject {
    ...
    @objc public weak var delegate: CameraPresenterDelegate?
    
    // MARK: - Public
    
    @objc public func presentCamera(from presentingViewController: UIViewController, with mediaUTIs: [MXKUTI], animated: Bool) {
