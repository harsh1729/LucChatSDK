                            ...
                            callInfo:(NSString *)callInfo
{
    ...
    if (self)
    {
        ...
        self.answerButton = [[CircleButton alloc] initWithImage:[UIImage imageNamed:@"voice_call_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil]
        ...
        self.answerTitleLabel.text = NSLocalizedStringFromTableInBundle(@"accept", @"Vector",[NSBundle bundleForClass:[self class]], nil);
        
        UIColor *rejectButtonBorderColor = ThemeService.shared.theme.warningColor;
        
        self.rejectButton = [[CircleButton alloc] initWithImage:[UIImage imageNamed:@"call_hangup_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil]
        ...
        self.rejectTitleLabel.text = NSLocalizedStringFromTableInBundle(@"decline", @"Vector",[NSBundle bundleForClass:[self class]], nil);
