...
@objc public protocol MediaPickerCoordinatorBridgePresenterDelegate {
...
@objcMembers
final public class MediaPickerCoordinatorBridgePresenter: NSObject {
    ...
    public weak var delegate: MediaPickerCoordinatorBridgePresenterDelegate?
    
    // MARK: - Setup
    
    public init(session: MXSession, mediaUTIs: [MXKUTI], allowsMultipleSelection: Bool) {
