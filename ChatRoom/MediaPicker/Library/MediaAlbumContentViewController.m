...
- (void)viewDidLoad
{
    ...
    {
        self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTableInBundle(@"media_picker_select", @"Vector",[NSBundle bundleForClass:[self class]], nil) style:UIBarButtonItemStylePlain target:self action:@selector(onSelect:)];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.item < assets.count)
    {
        ...
        cell.bottomRightIcon.image = [UIImage imageNamed:@"selection_tick" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
