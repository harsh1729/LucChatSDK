...
#import <MatrixKit/MXKBarButtonItem.h>
...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedStringFromTableInBundle(@"media_picker_title", @"Vector",[NSBundle bundleForClass:[self class]], nil);
    
    MXWeakify(self);
    
    UIBarButtonItem *closeBarButtonItem = [[MXKBarButtonItem alloc] initWithTitle:NSLocalizedStringFromTableInBundle(@"cancel", @"Vector",[NSBundle bundleForClass:[self class]], nil) style:UIBarButtonItemStylePlain action:^{
...
- (void)presentPermissionDeniedAlert
{
    ...
    NSString *message = [NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"photo_library_access_not_granted", @"Vector",[NSBundle bundleForClass:[self class]], nil), appDisplayName];
    
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:NSLocalizedStringFromTableInBundle(@"media_picker_title", @"Vector",[NSBundle bundleForClass:[self class]], nil)
                                                                   message:message
...
- (void)controlVideoPlayer
{
    ...
    if (videoPlayer.view.superview)
    {
        ...
        [videoPlayerControl setImage:[UIImage imageNamed:@"camera_play" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
        [videoPlayerControl setImage:[UIImage imageNamed:@"camera_play" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil] forState:UIControlStateHighlighted];
    }
    else
    {
        [[NSNotificationCenter defaultCenter] addObserver:self
        ...
        [videoPlayerControl setImage:[UIImage imageNamed:@"camera_stop" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
        [videoPlayerControl setImage:[UIImage imageNamed:@"camera_stop" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil] forState:UIControlStateHighlighted];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.item < recentCaptures.count)
    {
        ...
        cell.bottomLeftIcon.image = [UIImage imageNamed:@"video_icon" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
