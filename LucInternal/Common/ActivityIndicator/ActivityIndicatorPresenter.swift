...
public final class ActivityIndicatorPresenter: ActivityIndicatorPresenterType {
    ...
    public func presentActivityIndicator(on view: UIView, animated: Bool, completion: (() -> Void)? = nil) {
    ...
    public func removeCurrentActivityIndicator(animated: Bool, completion: (() -> Void)? = nil) {
