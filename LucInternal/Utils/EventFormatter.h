 ...
 */
extern NSString *const EventFormatterOnReRequestKeysLinkAction;

/**
 Parameters separator in the link string.
 */
extern NSString *const EventFormatterLinkActionSeparator;

/**
 Link string used in attributed strings to mark an edited event action.
 */
extern NSString *const EventFormatterEditedEventLinkAction;
