...
extern NSString *const kWidgetMatrixEventTypeString;
extern NSString *const kWidgetModularEventTypeString ;
extern NSString *const kWidgetTypeStickerPicker;

extern NSString *const kWidgetManagerDidUpdateWidgetNotification;

extern NSString *const WidgetManagerErrorDomain;
