    ...
    [room state:^(MXRoomState *roomState) {
        ...
        if (oneSelfPowerLevel < powerLevels.stateDefault)
        {
            error = [NSError errorWithDomain:WidgetManagerErrorDomain
                                    ...
                                    userInfo:@{
                                               NSLocalizedDescriptionKey: NSLocalizedStringFromTableInBundle(@"widget_no_power_to_manage", @"Vector",[NSBundle bundleForClass:[self class]], nil)
                                               }];
        }
            ...
            else
            {
                ...
                if (self->failureBlockForWidgetCreation[hash][widgetId])
                {
                    ...
                    NSError *error = [NSError errorWithDomain:WidgetManagerErrorDomain
                                                     ...
                                                     userInfo:@{
                                                                NSLocalizedDescriptionKey: NSLocalizedStringFromTableInBundle(@"widget_creation_failure", @"Vector",[NSBundle bundleForClass:[self class]], nil)
                                                                }];
                              ...
                              success:^(NSDictionary *JSONResponse)
         {
             ...
             if (failure)
             {
                 ...
                 NSError *error = [NSError errorWithDomain:WidgetManagerErrorDomain
                                                  ...
                                                  userInfo:@{
                                                             NSLocalizedDescriptionKey: NSLocalizedStringFromTableInBundle(@"widget_integrations_server_failed_to_connect", @"Vector",[NSBundle bundleForClass:[self class]], nil)
                                                             }];
...
- (NSError*)errorForNonConfiguredIntegrationManager
{
    return [NSError errorWithDomain:WidgetManagerErrorDomain
                           ...
                           userInfo:@{NSLocalizedDescriptionKey: NSLocalizedStringFromTableInBundle(@"widget_no_integrations_server_configured", @"Vector",[NSBundle bundleForClass:[self class]], nil)}];
}
