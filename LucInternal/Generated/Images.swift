...
internal enum Asset {
  internal enum Images {
    ...
    internal static let callConnected = ImageAsset(name: "call_connected")
    internal static let callConnecting = ImageAsset(name: "call_connecting")
    ...
    internal static let iconCallkit = ImageAsset(name: "icon_callkit")
