...
#pragma mark - UIViewController+LucSearch
#pragma mark -
...
- (void)showSearch:(BOOL)animated
{
    if (self.searchInternals.searchBarHidden)
    {
        ...
        //self.navigationItem.hidesBackButton = YES; //HARSH
...
{
    UIImage *searchBgImage = [MXKTools paintImage:[UIImage imageNamed:@"search_bg" inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil] withColor:ThemeService.shared.theme.matrixSearchBackgroundImageTintColor];
